...
actor_env_num = 8
evaluator_env_num = 5
smac_qmix_default_config_nandu1_1 = dict(
    env=dict(
...
smac_qmix_default_config_nandu1_1 = EasyDict(smac_qmix_default_config_nandu1_1)
main_config = smac_qmix_default_config_nandu1_1
