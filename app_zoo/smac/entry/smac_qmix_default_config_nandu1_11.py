...
smac_qmix_default_config_nandu1_11 = dict(
    env=dict(
...
smac_qmix_default_config_nandu1_11 = EasyDict(smac_qmix_default_config_nandu1_11)
main_config = smac_qmix_default_config_nandu1_11
