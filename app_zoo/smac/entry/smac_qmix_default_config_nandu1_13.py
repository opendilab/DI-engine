...
smac_qmix_default_config_nandu1_13 = dict(
    env=dict(
...
smac_qmix_default_config_nandu1_13 = EasyDict(smac_qmix_default_config_nandu1_13)
main_config = smac_qmix_default_config_nandu1_13
