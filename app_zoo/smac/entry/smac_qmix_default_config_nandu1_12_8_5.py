...
# support unroll_len mask
from easydict import EasyDict

agent_num = 8
actor_env_num = 16
evaluator_env_num = 10
smac_qmix_default_config_nandu1_12_8_5 = dict(
    env=dict(
...
smac_qmix_default_config_nandu1_12_8_5 = EasyDict(smac_qmix_default_config_nandu1_12_8_5)
main_config = smac_qmix_default_config_nandu1_12_8_5
