...
actor_env_num = 8
evaluator_env_num = 5
smac_qmix_default_config_nandu1_10 = dict(
    env=dict(
...
smac_qmix_default_config_nandu1_10 = EasyDict(smac_qmix_default_config_nandu1_10)
main_config = smac_qmix_default_config_nandu1_10
