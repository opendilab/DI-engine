...
smac_qmix_default_config_nandu1_12 = dict(
    env=dict(
...
smac_qmix_default_config_nandu1_12 = EasyDict(smac_qmix_default_config_nandu1_12)
main_config = smac_qmix_default_config_nandu1_12
