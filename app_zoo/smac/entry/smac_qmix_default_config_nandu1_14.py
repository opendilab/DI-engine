...
smac_qmix_default_config_nandu1_14 = dict(
    env=dict(
...
smac_qmix_default_config_nandu1_14 = EasyDict(smac_qmix_default_config_nandu1_14)
main_config = smac_qmix_default_config_nandu1_14
