...
from app_zoo.smac.model_zoo.config import smac_3s5z_qmix_main_config, smac_3s5z_qmix_create_config


def train_dqn(args):
    config = [smac_3s5z_qmix_main_config, smac_3s5z_qmix_create_config]
