...
from app_zoo.smac.model_zoo.config import smac_5m6m_qmix_main_config, smac_5m6m_qmix_create_config


def train_dqn(args):
    config = [smac_5m6m_qmix_main_config, smac_5m6m_qmix_create_config]
