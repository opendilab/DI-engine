...
nstep = 5
qbert_rainbowdqn_default_config = dict(
    env=dict(
...
qbert_rainbowdqn_default_config = EasyDict(qbert_rainbowdqn_default_config)
main_config = qbert_rainbowdqn_default_config
