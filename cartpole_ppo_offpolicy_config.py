...
cartpole_ppo_offpolicy_config = dict(
    exp_name='cartpole_ppo_offpolicy2',
    env=dict(
        collector_env_num=8,
        evaluator_env_num=5,
    ...
    policy=dict(
        ...
        collect=dict(
            demonstration_info_path ='/home/SENSETIME/weiyuhong/Desktop/Guided_cost_0825/DI-engine/cartpole_ppo_offpolicy/ckpt/ckpt_best.pth.tar',
            n_sample=128,
            unroll_len=1,
            discount_factor=0.9,
            gae_lambda=0.95,
