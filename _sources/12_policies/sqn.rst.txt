...
Q-learning algorithm, but adopt the maximum entropy framework, making a
...
2. SQN is an **off-policy** and **model-free** algorithm, and uses
   Boltzmann policy to do exploration.

3. SQN is based on **Q-learning** algorithm, which optimizes a
