...
collector_env_num = 8
minigrid_sil_ppo_config = dict(
    exp_name="minigrid_sil_ppo_seed0",
    env=dict(
        collector_env_num=8,
        evaluator_env_num=5,
...
minigrid_sil_ppo_config = EasyDict(minigrid_sil_ppo_config)
main_config = minigrid_sil_ppo_config
minigrid_sil_ppo_create_config = dict(
    env=dict(
        type='minigrid',
...
if __name__ == "__main__":
    # or you can enter `ding -m serial_sil -c minigrid_sil_ppo_config.py -s 0`
