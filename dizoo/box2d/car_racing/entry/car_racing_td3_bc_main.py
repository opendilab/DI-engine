...
from dizoo.box2d.car_racing.config.car_racing_td3_data_generation_config import main_config, create_config
from ding.entry import serial_pipeline_offline, collect_demo_data, eval, serial_pipeline


def train_td3_bc(args):
    from dizoo.box2d.car_racing.config.car_racing_td3_bc_config import main_config, create_config
...
def train_expert(args):
    from dizoo.box2d.car_racing.config.car_racing_td3_config import main_config, create_config
    main_config.exp_name = 'td3'
    config = deepcopy([main_config, create_config])
