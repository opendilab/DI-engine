...
lunarlander_ngu_config = dict(
    exp_name='debug_lunarlander_ngu_n5_bs2_ul98_trunc_er01',
    env=dict(
    ...
    policy=dict(
        ...
        collect=dict(
            ...
            n_sample=32, # the original env max length is 1000, need truncated to self._traj_len=self._unroll_len_add_burnin_step
