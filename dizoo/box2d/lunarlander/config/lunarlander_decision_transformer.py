...
lunarlander_dt_config = dict(
    ...
    policy=dict(
        ...
        n_heads =1,
        dropout_p=0.1,
        log_dir='/home/puyuan/DI-engine/dizoo/box2d/lunarlander/dt_log_10eps',  # debug
        model=dict(
            state_dim=8,
            act_dim=4,
            n_blocks=3,
        ...
        nstep=3,
        learn=dict(
            dataset_path='/home/puyuan/DI-engine/dizoo/box2d/lunarlander/dt_data/data/dqn_data_10eps.pkl',  # debug
            learning_rate=0.001,
...
if __name__ == "__main__":
    ...
    serial_pipeline_dt([main_config, create_config], seed=0, max_train_iter=1000)
