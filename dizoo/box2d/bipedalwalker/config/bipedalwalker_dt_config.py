...
bipedalwalker_dt_config = dict(
    ...
    policy=dict(
        ...
        n_heads=1,
        dropout_p=0.1,
        log_dir='/home/wangzilin/projects/decision_transformer/DI-engine/dizoo/box2d/bipedalwalker/dt_data/dt_log_1000eps',
        model=dict(
            state_dim=24,
            act_dim=4,
            n_block=3,
        ...
        nstep=3,
        learn=dict(
            dataset_path='/home/wangzilin/projects/decision_transformer/DI-engine/dizoo/box2d/bipedalwalker/dt_data/data/sac_data_1000eps.pkl',
            learning_rate=0.001,
