...
game_arg.add_argument(
    ...
    default=3,
    help=
    'if it is "0", it uses the current "agentType", otherwise sets agent types according to the function setAgentType() in this file.'
)
game_arg.add_argument(
    '--ifUseTotalReward',
    type=str2bool,
...
DQN_arg.add_argument(
    '--minReplayMem', type=int, default=50000, help='the minimum of experience reply size to start dnn'
)
...
DQN_arg.add_argument(
    '--saveInterval', type=int, default=10000, help='every xx training iteration, saves the games network'
)
...
DQN_arg.add_argument(
    '--Minlr', type=float, default=1e-8, help='the minimum learning rate, if it drops below it, fix it there '
)
DQN_arg.add_argument(
    '--ifDecayAdam', type=str2bool, default=True, help='decays the learning rate of the adam optimizer'
)
...
DQN_arg.add_argument(
    '--display', type=int, default=1000, help='the number of iterations between two display of results.'
)
DQN_arg.add_argument('--momentum', type=float, default=0.9, help='the momentum value')
DQN_arg.add_argument(
    '--dnnUpCnt', type=int, default=10000, help='the number of iterations that updates the dnn weights'
)
...
utility_arg.add_argument(
    '--gpu_memory_fraction', type=float, default=0.1, help='the fraction of gpu memory which we are gonna use'
)
# Dirs
...
test_arg.add_argument('--saveFigInt', type=list, default=[900, 1000], help='')
test_arg.add_argument('--saveFigIntLow', type=int, default=4000, help='')
test_arg.add_argument('--saveFigIntUp', type=int, default=5000, help='')
test_arg.add_argument(
...
def fillnodes(config):
    if config.NoHiLayer == 2:
        ...
        config.nodes = [
            config.stateDim * config.multPerdInpt, config.node1, config.node2, config.node3, config.actionListLen
        ]
