...
main_config = dict(
    exp_name='halfcheetach_sac_1step_ddppo_seed0',
    env=dict(
        env_id=env_id,
...
if __name__ == '__main__':
    ...
    params = vars(args)
    seed = params['seed']
    main_config.exp_name = f'halfcheetach_sac_1step_ddppo_seed{seed}'
    serial_pipeline_mbrl((copy.deepcopy(main_config), copy.deepcopy(create_config)), 
                         seed=seed, max_env_step=100000)
