...
walker2d_ppo_default_config = dict(
    ...
    policy=dict(
        ...
        learn=dict(
            ...
            # for walker2d, the length=1000
            ignore_done=False,  # NOTE
...
def train(args):
    main_config.exp_name='walker2d_offppo_noig'+'_seed'+f'{args.seed}'
    import copy
    # 937.4 iterations= 3M env steps / 3200 
    serial_pipeline([copy.deepcopy(main_config), copy.deepcopy(create_config)], seed=args.seed, max_iterations= int(1000),)
