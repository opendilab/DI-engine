...
from ding.entry import serial_pipeline_trex_onpolicy, serial_pipeline_trex

# Note serial_pipeline_trex_onpolicy is for on policy ppo whereas serial_pipeline_trex is for sac
