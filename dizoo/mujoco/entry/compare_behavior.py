...
from dizoo.mujoco.config.walker2d_gail_config import walker2d_gail_default_config,\
...
if __name__ == "__main__":
    eval_behavior((walker2d_gail_default_config, walker2d_gail_default_create_config),
                  (walker2d_ddpg_default_config, walker2d_gail_default_create_config),
                  actions_type='continuous',
                  seed=0)
