...
from ding.model.template.efficientzero.efficientzero_gomoku_model import EfficientZeroNet


class GomokuConfig(BaseConfig):
    def __init__(self):
        super(GomokuConfig, self).__init__(
        ...
        # TODO(pu):
        self.env_name = 'Gomoku'
        self.action_space_size = int(15 * 15)
        self.amp_type = 'none'
        # self.obs_shape = (3, 15, 15)
        self.obs_shape = (12, 15, 15)  # if stacked_observations=4
