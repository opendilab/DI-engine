...
halfcheetah_dt_config = dict(
    exp_name='halfcheetah_dt_1000eps_seed0',
    env=dict(
    ...
    policy=dict(
        ...
        n_heads=1,
        dropout_p=0.1,
        log_dir='/home/wangzilin/research/dt/DI-engine/dizoo/d4rl/dt_data/dt_halfcheetah_log',
        model=dict(
            state_dim=17,
            act_dim=6,
            n_blocks=3,
        ...
        nstep=3,
        learn=dict(
            dataset_path='/home/wangzilin/research/dt/DI-engine/dizoo/d4rl/dt_data/data/halfcheetah-medium-v2.pkl',
            learning_rate=0.001,
