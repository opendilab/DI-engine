...
hopper_dt_config = dict(
    exp_name='hopper_dt_1000eps_seed0',
    env=dict(
        env_id='Hopper-v3',
    ...
    policy=dict(
        ...
        n_heads=1,
        dropout_p=0.1,
        log_dir='/home/wangzilin/research/dt/DI-engine/dizoo/d4rl/dt_data/dt_hopper_log',
        model=dict(
            state_dim=11,
            act_dim=3,
            n_blocks=3,
        ...
        nstep=3,
        learn=dict(
            dataset_path='/home/wangzilin/research/dt/DI-engine/dizoo/d4rl/dt_data/data/hopper-medium-v2.pkl',
            learning_rate=0.001,
