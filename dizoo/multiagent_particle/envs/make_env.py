...
def make_env(scenario_name, num_agents=None, num_landmarks=None, num_good_agents=None, cfg=None, benchmark=False):
    ...
    '''
    from dizoo.multiagent_particle.envs.multiagent.environment import MultiAgentEnv
    import dizoo.multiagent_particle.envs.multiagent.scenarios as scenarios
