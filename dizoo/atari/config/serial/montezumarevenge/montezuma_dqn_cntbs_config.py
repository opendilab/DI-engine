...
montezuma_dqn_config = EasyDict(montezuma_dqn_config)
main_config = montezuma_dqn_config
montezuma_dqn_create_config = dict(
    env=dict(
        type='atari',
...
montezuma_dqn_create_config = EasyDict(montezuma_dqn_create_config)
create_config = montezuma_dqn_create_config
