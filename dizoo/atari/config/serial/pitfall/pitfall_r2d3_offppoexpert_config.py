...
"""agent config"""
pitfall_r2d3_config = dict(
    exp_name='debug_pitfall_r2d3_offppoexpert_k0_pho1-256_rbs2e4',
    env=dict(
...
pitfall_r2d3_config = EasyDict(pitfall_r2d3_config)
main_config = pitfall_r2d3_config
pitfall_r2d3_create_config = dict(
    env=dict(
        type='atari',
...
pitfall_r2d3_create_config = EasyDict(pitfall_r2d3_create_config)
create_config = pitfall_r2d3_create_config


"""export config"""
expert_pitfall_r2d3_config = dict(
    exp_name='expert_pitfall_r2d3_offppoexpert_k0_pho1-256_rbs2e4',
    env=dict(
        # Whether to use shared memory. Only effective if "env_manager_type" is 'subprocess'
        manager=dict(shared_memory=True, force_reproducibility=True),
        collector_env_num=collector_env_num,
    ...
    policy=dict(
        ...
        collect=dict(
            ...
            # demonstration_info_path='dizoo/atari/config/serial/pitfall/demo_path/ppo-off_iteration_16127.pth.tar',
...
expert_pitfall_r2d3_config = EasyDict(expert_pitfall_r2d3_config)
expert_main_config = expert_pitfall_r2d3_config
expert_pitfall_r2d3_create_config = dict(
    env=dict(
        type='atari',
        import_names=['dizoo.atari.envs.atari_env'],
    ),
...
expert_pitfall_r2d3_create_config = EasyDict(expert_pitfall_r2d3_create_config)
expert_create_config = expert_pitfall_r2d3_create_config
