...
qbert_r2d2_config = dict(
    exp_name='qbert_r2d2_n5_bs20_ul80_rbs1e4_cfg2',
    env=dict(
    ...
    policy=dict(
        ...
        model=dict(
            ...
            encoder_hidden_size_list=[128, 256, 512],  # TODO(pu)
            res_link=False,
        ),
        ...
        learn=dict(
            ...
            update_per_collect=32,  # TODO(pu): 8
            batch_size=64,
...
def train(args):
    main_config.exp_name = 'qbert_r2d2_n5_bs20_ul80_rbs1e4_cfg2' + '_seed' + f'{args.seed}'
    import copy
    # 3125 iterations= 10M env steps / (100*32) env steps
    serial_pipeline([copy.deepcopy(main_config), copy.deepcopy(create_config)], seed=args.seed, max_iterations=4000)
