...
pong_dqn_envpool_large_batch_config = dict(
...
pong_dqn_envpool_large_batch_config = EasyDict(pong_dqn_envpool_large_batch_config)
main_config = pong_dqn_envpool_large_batch_config
