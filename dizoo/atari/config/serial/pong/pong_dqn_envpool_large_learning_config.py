...
pong_dqn_envpool_large_learning_config = dict(
...
pong_dqn_envpool_large_learning_config = EasyDict(pong_dqn_envpool_large_learning_config)
main_config = pong_dqn_envpool_large_learning_config
