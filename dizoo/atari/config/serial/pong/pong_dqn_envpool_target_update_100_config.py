...
pong_dqn_envpool_target_update_100_config = dict(
...
pong_dqn_envpool_target_update_100_config = EasyDict(pong_dqn_envpool_target_update_100_config)
main_config = pong_dqn_envpool_target_update_100_config
