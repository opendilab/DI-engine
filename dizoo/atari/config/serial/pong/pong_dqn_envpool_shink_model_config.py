...
pong_dqn_envpool_shink_model_config = dict(
    exp_name='pong_dqn_envpool_shink_model_seed0',
    env=dict(
        collector_env_num=8,
...
pong_dqn_envpool_shink_model_config = EasyDict(pong_dqn_envpool_shink_model_config)
main_config = pong_dqn_envpool_shink_model_config
