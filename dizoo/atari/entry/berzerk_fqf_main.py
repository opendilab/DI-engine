...
from dizoo.atari.config.serial.berzerk.berzerk_fqf_config import berzerk_fqf_config, create_config
...
def main(cfg, create_cfg, seed=0):
    ...
    while True:
        ...
        if collector.envstep >= 25000000:
            break

if __name__ == "__main__":
    # with DistContext():
    main(berzerk_fqf_config, create_config)