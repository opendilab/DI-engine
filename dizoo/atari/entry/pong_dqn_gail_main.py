...
from dizoo.atari.config.serial.pong.pong_dqn_gail_config import *
from dizoo.atari.config.serial.pong.pong_dqn_config import *
...
if __name__ == "__main__":
    main(
        (pong_dqn_gail_config, pong_dqn_gail_create_config), (pong_dqn_config, pong_dqn_create_config),
        collect_data=True,
        seed=0
    )
