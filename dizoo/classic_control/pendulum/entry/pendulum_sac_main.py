...
from dizoo.classic_control.pendulum.config.pendulum_sac_config import pendulum_sac_config
...
def main(cfg, seed=0):
    ...
    while True:
        ...
        # tb_logger.add_scalar('scheduled_lr', learner.train_iter)
        # tb_logger.add_scalar('evaluation_reward', reward, collector.envstep)



if __name__ == "__main__":
    main(pendulum_sac_config, seed=0)
