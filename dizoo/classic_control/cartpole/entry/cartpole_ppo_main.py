...
from ding.worker import BaseLearner, SampleCollector, InteractionSerialEvaluator
...
def main(cfg, seed=0, max_iterations=int(1e10)):
    cfg = compile_config(
        cfg, BaseEnvManager, PPOPolicy, BaseLearner, SampleCollector, InteractionSerialEvaluator, save_cfg=True
    )
