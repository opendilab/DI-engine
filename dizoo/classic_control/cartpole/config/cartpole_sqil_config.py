...
cartpole_sqil_config = dict(
    ...
    policy=dict(
        ...
        collect=dict(n_sample=8, demonstration_info_path = '/home/SENSETIME/nieyunpeng/nerveX/dizoo/classic_control/cartpole/config/This_is_demo_data_cartpole/ckpt/ckpt_best.pth.tar'), #'/home/SENSETIME/nieyunpeng/nerveX/app_zoo/classic_control/cartpole/config/ckpt_BaseLearner_Wed_Jun_23_20_54_33_2021/ckpt_best.pth.tar'),
