...
cartpole_expert_model_config = dict(
    ...
    policy=dict(
        ...
        collect=dict(n_sample=96, demonstration_model_path = '/Users/nieyunpeng/Documents/open-sourced-algorithms/BC_DI-engine/dizoo/classic_control/cartpole/config/cartpole_dqn/ckpt/ckpt_best.pth.tar', demonstration_offline_data_path = '/Users/nieyunpeng/Documents/open-sourced-algorithms/BC_DI-engine/dizoo/behaviour_cloning/entry/expert_data.pkl'),
        eval=dict(
            batch_size=32,
            evaluator=dict(
                eval_freq=1,
