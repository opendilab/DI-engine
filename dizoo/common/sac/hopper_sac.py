...
agent = SACAgent(env="hopper", exp_name="Hopper-v3-SAC")
# Train the agent
...
''',
    usage_file_by_git_clone="./dizoo/common/sac/hopper_sac_deploy.py",
    usage_file_by_huggingface_ding="./dizoo/common/sac/hopper_sac_download.py",
