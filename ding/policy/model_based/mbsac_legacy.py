...
class MBSACPolicy(SACPolicy):
    ...
    config = dict(
        learn=dict(
            ...
            # STEVE style value expansion (arXiv 1807.01675) will be supported soon.
            ...
            # (float) Critic net weight decay for value gradient.
            # Disabled when 0.
            ...
            # (float) Actor net weight decay for value gradient.
            # Disabled when 0.
