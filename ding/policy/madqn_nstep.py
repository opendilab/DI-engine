...
from ding.rl_utils import v_1step_td_data, v_1step_td_error, get_train_sample, v_nstep_td_data, v_nstep_td_error
...
@POLICY_REGISTRY.register('madqn_nstep')
class MADQNNSTEPPolicy(QMIXNSTEPPolicy):
    config = dict(
    ...
    def default_model(self) -> Tuple[str, List[str]]:
        ...
        """
        return 'siql', ['ding.model.template.siql']
    ...
    def _monitor_vars_learn(self) -> List[str]:
        ...
        #]
        return [
            'cur_lr', 'total_loss', 'total_q', 'target_total_q', 'grad_norm',
            'boost_grad_norm', 'boost_loss'
        ]