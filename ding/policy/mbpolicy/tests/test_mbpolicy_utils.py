import pytest
import torch
from ding.policy.mbpolicy.utils import fold_batch, unfold_batch, q_evaluation
...
def test_fold_unfold_batch():
    ...
    data, batch_dim = fold_batch(data, nonbatch_dims=3)
    ...
    data, batch_dim = fold_batch(data, nonbatch_dims=1)
