...
def _get_next_log_count_per_token(token):
    ...
    Returns:
        - ret: The number of times this function has been called 
            with *token* as an argument (starting at 0).
    """
...
def _seconds_have_elapsed(token, num_seconds):
    ...
    Returns:
        - ret: Whether it has been >= 'num_seconds' since 'token' was last requested.
    """
...
def log_every_n(level, n, msg, *args):
    ...
    Overview:
        ...
        Not threadsafe.
    Arguments:
        - level (:obj:`int`): the absl logging level at which to log.
        - msg (:obj:`str`): the message to be logged.
        - n (:obj:`int`): the number of times this should be called before it is logged.
...
def log_every_sec(level, n_seconds, msg, *args):
    ...
    Arguments:
        - level (:obj:`int`): the absl logging level at which to log.
        - msg (:obj:`str`): the message to be logged.
        - n_seconds (:obj:`Union[int, float]`): seconds which should elapse before logging again.
        - *args: The args to be substituted into the msg.
    """
