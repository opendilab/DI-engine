...
def try_import_ceph():
    ...
    try:
        ...
        try:
            ...
            if ceph_flag:
                logging.warning("You have not installed ceph package! DI-engine has changed to some alternatives.")
            ceph = None
            ceph_flag = False
            return ceph
...
def try_import_mc():
    ...
    try:
        ...
        if mc_flag:
            logging.warning("You have not installed memcache package! DI-engine has changed to some alternatives.")
        mc = None
        mc_flag = False
    return mc
...
def try_import_redis():
    ...
    try:
        ...
        if redis_flag:
            logging.warning("You have not installed redis package! DI-engine has changed to some alternatives.")
        redis = None
        redis_flag = False
    return redis
...
def try_import_rediscluster():
    ...
    try:
        ...
        if rediscluster_flag:
            logging.warning("You have not installed rediscluster package! DI-engine has changed to some alternatives.")
        rediscluster = None
...
def try_import_link():
    ...
    if ding.enable_linklink:
        try:
            ...
            if linklink_flag:
                logging.warning("You have not installed linklink package! DI-engine has changed to some alternatives.")
