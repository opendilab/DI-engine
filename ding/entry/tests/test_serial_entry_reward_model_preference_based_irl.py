...
from ding.entry import serial_pipeline_reward_model_preference_based_irl
...
def test_serial_pipeline_reward_model_trex():
    ...
    try:
        serial_pipeline_reward_model_preference_based_irl(config, seed=0, max_train_iter=1)
