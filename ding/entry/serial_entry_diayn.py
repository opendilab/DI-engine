...
def serial_pipeline_diayn(
    ...
    if cfg.policy.get('random_collect_size', 0) > 0:
        ...
        new_data = collector.collect_diayn(
            num_skills=cfg.policy.collect.num_skills,
            n_sample=cfg.policy.random_collect_size,
    ...
    for _ in range(max_iterations):
        ...
        new_data = collector.collect_diayn(
            num_skills=cfg.policy.collect.num_skills, train_iter=learner.train_iter, policy_kwargs=collect_kwargs
        )
