...
def serial_pipeline_sqil(
    ...
    expert_policy.collect_mode.load_state_dict(torch.load('/home/SENSETIME/nieyunpeng/nerveX/dizoo/classic_control/cartpole/config/This_is_demo_data_cartpole/ckpt/ckpt_best.pth.tar', map_location='cpu'))
