...
from dizoo.atari.config.serial.pong.pong_sqil_config import main_config, create_config
from dizoo.atari.config.serial.pong.pong_sqil_config import pong_sqil_config
