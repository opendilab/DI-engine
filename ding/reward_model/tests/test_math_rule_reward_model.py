...
def test_math_rule_reward_model_correct_answer(reward_model):
    data_correct = [
        {
            ...
            "query": "The school now introduces a new color, silver, for the flag design. Crestview's school colors are now purple, gold, and silver. The students are designing a flag using three solid-colored horizontal stripes. Using one, two, or all three of the school colors, how many different flags are possible if adjacent stripes may be the same color?",
            "response": r"Crestview's school colors—purple, gold, and silver—can be used to design a flag with three horizontal stripes, where each stripe can be any of the three colors and adjacent stripes may be the same. Since each of the three stripes has three independent color choices, the total number of possible flag designs is 27",
            "answer": r"27"
        }
    ]
    ...
    assert rewards[0]['metadata']['match_result'] == True
...
def test_math_rule_reward_model_wrong_answer(reward_model):
    data_wrong = [
        {
            "system": "Please answer this math problem...",
            "query": "The school now introduces a new color, silver, for the flag design. Crestview's school colors are now purple, gold, and silver. The students are designing a flag using three solid-colored horizontal stripes. Using one, two, or all three of the school colors, how many different flags are possible if adjacent stripes may be the same color?",
            "response": r"The given point \(\left(\frac{\sqrt{3}}{2}, -\frac{1}{2}\right)\) lies on the unit circle, meaning its coordinates correspond to \((\cos \alpha, \sin \alpha)\). Since \(\cos \alpha = \frac{\sqrt{3}}{2}\) and \(\sin \alpha = -\frac{1}{2}\), the angle \(\alpha\) is in the **fourth quadrant**, where the reference angle is \(\frac{\pi}{6}\). Therefore, the smallest positive value of \(\alpha\) is \(2\pi - \frac{\pi}{6} = \frac{17\pi}{6}\).",
    ...
    assert rewards[0]['metadata']['match_result'] == False
