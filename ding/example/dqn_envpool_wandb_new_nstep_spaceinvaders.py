...
if __name__ == "__main__":
    ...
    spaceinvaders_dqn_envpool_config.env.collector_env_num = arg.collector_env_num
    spaceinvaders_dqn_envpool_config.env.collector_batch_size = arg.collector_batch_size
    spaceinvaders_dqn_envpool_config.seed = arg.seed
    spaceinvaders_dqn_envpool_config.env.stop_value = 1000000000
    spaceinvaders_dqn_envpool_config.nstep = 3
    spaceinvaders_dqn_envpool_config.policy.nstep = 3
    spaceinvaders_dqn_envpool_config.seed = arg.seed

    main(spaceinvaders_dqn_envpool_config)
