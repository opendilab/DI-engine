...
def main(cfg):
    ...
    cfg.exp_name = 'Pong-v5-DQN-envpool-new-7-' + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
...
if __name__ == "__main__":
    ...
    pong_dqn_envpool_config.policy.learn.update_per_collect = 5
    pong_dqn_envpool_config.policy.learn.batch_size = 32
    pong_dqn_envpool_config.policy.learn.learning_rate = 0.0001
    pong_dqn_envpool_config.policy.learn.target_update_freq = 200
