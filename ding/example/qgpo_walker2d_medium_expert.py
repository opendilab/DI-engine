...
main_config = dict(
    ...
    policy=dict(
        ...
        learn=dict(
            ...
            q_value_stop_training_iter=100000,  #700000,
        ),
...
# TASK="walker2d-medium-expert-v2"; seed=0; setting="reproduce";
# python3
# -u train_critic.py
# --actor_load_path models_rl/walker2d-medium-expert-v20reproduce/behavior_ckpt600.pth
# --expid $TASK${seed}${setting}
# --env $TASK
# --diffusion_steps 15
# --seed ${seed}
