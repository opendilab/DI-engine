...
main_config = dict(
    exp_name='hopper_medium_replay_v2_QGPO_seed0',
    seed=0,
    env=dict(
    ...
    policy=dict(
        cuda=True,
        on_policy=False,
        #load_path='./hopper_medium_replay_v2_QGPO_seed0/ckpt/iteration_600000.pth.tar',
        model=dict(
            score_net=dict(
                device='cuda',
                score_base=dict(
...
# TASK="hopper-medium-replay-v2"; seed=0; setting="reproduce";
# python3
# -u train_critic.py
# --actor_load_path models_rl/hopper-medium-replay-v20reproduce/behavior_ckpt600.pth
# --expid $TASK${seed}${setting}
# --env $TASK
# --diffusion_steps 15
# --seed ${seed}
