...
from ding.reward_model import ICMRewardModel
...
from dizoo.classic_control.cartpole.config.cartpole_dqn_icm_config import main_config, create_config
...
def main():
    ...
    with task.start(async_mode=False, ctx=OnlineRLContext()):
        ...
        reward_model = ICMRewardModel(cfg.reward_model)
