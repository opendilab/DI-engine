...
class SACAgent:
    """
    Overview:
        Class of agent for training, evaluation and deployment of Reinforcement learning algorithm Soft Actor-Critic(SAC).
    Interface:
    ...
    def __init__(
        ...
        .. note::
            ...
            with SAC algorithm with default configuration. Then we can initialize the agent in the following ways: 
