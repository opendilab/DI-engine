...
class TD3Agent:
    """
    Overview:
        Class of agent for training, evaluation and deployment of Reinforcement learning algorithm Twin Delayed Deep Deterministic Policy Gradient(TD3).
    Interface:
    ...
    def __init__(
        ...
        Arguments:
            ...
            - model (:obj:`torch.nn.Module`): The model of TD3 algorithm, which should be an instance of class \
                :class:`ding.model.ContinuousQAC`. If not specified, a default model will be generated according to the configuration.
        ...
        .. note::
            ...
            For example, we have an environment with id ``LunarLanderContinuous-v2`` registered in gym, and we want to train an agent \
            with TD3 algorithm with default configuration. Then we can initialize the agent in the following ways: 
