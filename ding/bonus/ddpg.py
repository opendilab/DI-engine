...
class DDPGAgent:
    """
    Overview:
        Class of agent for training, evaluation and deployment of Reinforcement learning algorithm Deep Deterministic Policy Gradient(DDPG).
    Interface:
    ...
    def __init__(
        ...
        .. note::
            ...
            with DDPG algorithm with default configuration. Then we can initialize the agent in the following ways: 
