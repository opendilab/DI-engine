...
class PPOOffPolicyAgent:
    """
    Overview:
        Class of agent for training, evaluation and deployment of Reinforcement learning algorithm Proximal Policy Optimization(PPO) in an off-policy style.
    Interface:
    ...
    def __init__(
        ...
        .. note::
            ...
            with PPO (offpolicy) algorithm with default configuration. Then we can initialize the agent in the following ways: 
