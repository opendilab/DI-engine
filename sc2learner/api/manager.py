...
class Manager(object):
    ...
    def __init__(self, cfg):
        ...
        self.actor_record = {} # {actor_uid: {"job_ids": [job_id], "last_beats_time": last_beats_time, "state": 'alive'/'dead'}}}
    ...
    def check_actor_dead(self):
        while True:
            ...
            for actor_uid, actor_info in self.actor_record.items():
                if actor_info['state'] == 'alive' and nowtime - actor_info['last_beats_time'] > self.check_dead_actor_freq:
                    # dead actor
                    self.logger.info("[manager][check_actor_dead] {} is dead, last_beats_time = {}"
                                .format(actor_uid, self.time_format(actor_info['last_beats_time'])))
