...
def download(key, secret, version, replays_dir, download_dir, zip_bin_path=None, extract=False, remove=False, filter_version='keep'):
...
def main():
    ...
    parser.add_argument('--7zip_path', dest='zip_bin_path', default=r'C:\Program Files\7-Zip\7z.exe', help='Where the 7zip binary resides (for Windows)')
    parser.add_argument(
        '--filter_version',
        default='keep',
