...
For scalability, nerveX supports three different training pipeline:
  ...
  - ``serial``
    ...
    - usage: academical research and algorithm validation
  - ``parallel``
  ...
  - ``dist``
    ...
    - pipeline: mutli machine multi-gpu learner-collector distributed execution
...
--------------
  ...
  * Large scale DRL training demostration and application
  ...
  * k8s support, nerveX-operator k8s lustre scheduler for dynamic collector and other services
  * 95%+ code coverage and simple algorithm performance test, PEP8 codestyle and typing lint
...
If you want to deeply customize you algorithm and application with nerveX, also checkout `key concept <./key_concept/index.html>`_ and `Feature <./feature/index.html>`_. 
