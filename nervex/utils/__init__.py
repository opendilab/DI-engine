...
from .registry_factory import registries, POLICY_REGISTRY, ENV_REGISTRY, SERIAL_COLLECTOR_REGISTRY, \
    LEARNER_REGISTRY, COMM_LEARNER_REGISTRY, COMMANDER_REGISTRY, LEAGUE_REGISTRY, PLAYER_REGISTRY, MODEL_REGISTRY, \
    ENV_MANAGER_REGISTRY, REWARD_MODEL_REGISTRY, PARALLEL_COLLECTOR_REGISTRY, COMM_COLLECTOR_REGISTRY
