...
from .registry_factory import registries, POLICY_REGISTRY, ENV_REGISTRY, ACTOR_REGISTRY, LEARNER_REGISTRY, \
    COMMANDER_REGISTRY, LEAGUE_REGISTRY, PLAYER_REGISTRY
