...
class TestReplayBuffer:
    ...
    def test_serial(self, setup_config):
        ...
        while time.time() - begin_time < 30:
            ...
            while produce_count < 100:
                if random.randint(0, 100) > 80:
                    # print('[PRODUCER] produce 1 data')
                    replay_buffer.push_data(generate_data())
                    produce_count += 1
                else:
                    data_count = random.randint(10, 50)
            ...
            while consume_count < 20:
                ...
                # print('[CONSUMER] iteration {} training finish'.format(iteration))
