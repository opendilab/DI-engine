...
def setup_league(setup_payoff, setup_config):
    ...
    for category in ['zerg', 'terran', 'protoss']:
        ...
        players.append(
            MainPlayer(
                setup_config.league.main_player, category, setup_payoff, 'ckpt_{}.pth'.format(main_player_name),
                main_player_name, 0
            )
        )
        ...
        players.append(
            MainExploiter(
                setup_config.league.main_exploiter, category, setup_payoff, 'ckpt_{}.pth'.format(main_exploiter_name),
                main_exploiter_name, 0
            )
        )
